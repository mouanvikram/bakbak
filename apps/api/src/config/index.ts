...
export const env = {
	...
	JWT_ISSUER: process.env.JWT_ISSUER || "bakbak-api",
	JWT_AUDIENCE: process.env.JWT_AUDIENCE || "bakbak-web",
	...
	TOKEN_CLEANUP_INTERVAL_MS: Number(process.env.TOKEN_CLEANUP_INTERVAL_MS) || 60 * 60 * 1000,

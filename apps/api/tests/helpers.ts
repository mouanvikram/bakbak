...
import type { User } from "@sealchat/db";
...
export async function authHeader(userId: string, username: string): Promise<Record<string, string>> {
...
export async function createTestUser(overrides: Partial<{
	...
	const passwordHash = overrides.passwordHash || await Bun.password.hash("TestPass123!", {
		algorithm: "argon2id",
		timeCost: 3,
		memoryCost: 65536,
	});

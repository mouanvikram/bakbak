...
export function RecoverAccountPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to request account recovery",
      );
      setStatus("error");
    }
  }
          ...
          <>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm leading-6 text-gray-500">
                Enter the email address of the deleted account and we'll send
                you a recovery link.
              </p>
            </div>
            ...
            <Button value="Send Recovery Link" onClick={handleSubmit} />
        ...
        {status === "loading" && (
          <>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm leading-6 text-gray-500">
                Please wait while we send the recovery email.
              </p>
            </div>
          </>
        )}
        {status === "success" && (
          <>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm leading-6 text-gray-500">
                If your account is within its 30-day recovery window, we've
                sent you a link to recover it.
              </p>
            </div>
            <div className="w-full rounded-lg bg-gray-50 px-4 py-3 text-left text-sm text-gray-500">
          ...
          <>
            ...
            <div className="flex w-full gap-3">
              <button
                type="button"
                onClick={() => setStatus("idle")}
                className="flex h-11 flex-1 cursor-pointer items-center justify-center rounded-lg border border-gray-200 font-medium text-gray-700 transition hover:bg-gray-50"
              >
                Try Again
              </button>
              <Link

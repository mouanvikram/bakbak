        ...
        >
          ...
          <div className="flex items-center gap-3 px-5 pt-4">
            <button
              ...
              className="focus-visible:outline-brand-500 relative shrink-0 rounded-full outline-none focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              <Avatar
                name={name || "Group"}
                src={avatarPreview}
                className="size-14"
              />
              <span className="bg-brand-500 absolute -right-0.5 -bottom-0.5 flex size-6 items-center justify-center rounded-full border-2 border-white text-white">
                {avatarUploading ? (
            ...
            <input
              ...
              autoFocus
              maxLength={100}
              className="focus-visible:ring-brand-500/30 h-10 min-w-0 flex-1 rounded-lg bg-slate-50 px-3 text-sm outline-none placeholder:text-slate-400 focus-visible:ring-2"
            />
          </div>
                    ...
                    <span
                      className={cn(
                        ...
                        isSel
                          ...
                          : "group-hover:border-brand-400 group-hover:text-brand-400/50 border-gray-300 text-transparent",
                      )}
                    >

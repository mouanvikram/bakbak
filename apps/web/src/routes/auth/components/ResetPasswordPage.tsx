...
import { CheckCircle2, LockKeyhole, LoaderCircle, XCircle } from "lucide-react";
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            {status === "expired" && (
              <>
                ...
                <Link
                  to="/forgot-password"
                  className="flex h-11 w-full items-center justify-center rounded-xl bg-linear-to-br from-[#805FF8] to-[#4C18EF] font-bold text-white transition hover:opacity-95"
                >
            ...
            {status === "error" && (
              <>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm leading-6 text-gray-500">
                    The reset link may be invalid or something went wrong.

...
export function AccountPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      console.log({ firstName, lastName, displayName, bio });
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="flex flex-col gap-6">
        ...
        <label className="flex flex-col gap-2">
          ...
          <textarea
            ...
            rows={4}
            className="rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm text-gray-800 outline-none transition focus:border-[#805FF8] focus:ring-2 focus:ring-[#805FF8]/10"
